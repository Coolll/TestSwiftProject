...
public extension Int {
    ...
    var kFormatted: String {
        ...
        if abs == 0 {
            return "0k"
        } else if abs >= 0 && abs < 1_000 {
            return "0k"
        } else if abs >= 1_000 && abs < 1_000_000 {
            return String(format: "\(sign)%ik", abs / 1_000)
        }
...
public extension Int {
    ...
    func romanNumeral() -> String? {
        ...
        let arabicValues = [1_000, 900, 500, 400, 100, 90, 50, 40, 10, 9, 5, 4, 1]
