...
public extension Dictionary {
    ...
    func safelyGet(_ key: String?) -> String {
        if key == "" || key == nil {
            print("safelyGet: key is invalid")
            return ""
        }
        ...
        if let value = self[key as! Key] {
            if let stringValue = value as? String {
                ...
                print("safelyGet: value is not String")
                return ""
            }
        } else {
            print("safelyGet: no value")
            return ""
        }
    }

    func safelyGetBool(_ key: String?) -> Bool {
        if key == "" || key == nil {
            print("safelyGet: key is invalid")
            return false
        }
        ...
        if let value = self[key as! Key] {
            if let boolValue = value as? Bool {
                ...
                print("safelyGet: value is not Bool")
                return false
            }
        } else {
            print("safelyGet: no value")
